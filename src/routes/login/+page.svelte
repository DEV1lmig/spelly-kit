...
<div class="flex flex-col justify-center items-center min-h-screen w-full">
	...
	<form method="POST" class="flex flex-col items-center space-y-2 w-full max-w-lg mx-auto pt-4">
		<button formaction="?/login&provider=github" type="submit" class="btn btn-primary w-full"
			>Iniciar sesión con github</button
		>
	</form>
</div>
